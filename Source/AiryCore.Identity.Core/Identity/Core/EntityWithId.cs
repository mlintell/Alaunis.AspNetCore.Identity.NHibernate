namespace AiryCore.Identity.Core
{
    ...
    public abstract class EntityWithId<TId>
    {
        ...
        {
            return this.EntityEquals(obj as EntityWithId<TId>);
        }
        ...
        /// </summary>
        /// <returns>An <see cref="int"/> that will not change during the lifetime of this object.</returns>
        ...
        public override int GetHashCode()
        {
            ...
            this._cachedHashCode = this.IsTransient() ? base.GetHashCode() : this.Id.GetHashCode();
