...
{
    /// <summary>
    /// Interface that defines the minimal set of data required to persist a roles claim information using NHibernate.
    /// </summary>
    public interface IIdentityRoleClaim<out TClaimKey, TRole>
    {
        /// <summary>
