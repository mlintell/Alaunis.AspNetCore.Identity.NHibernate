namespace AiryCore.UserTypes
{
    ...
    public class DateTimeOffsetSplitType : ICompositeUserType
    {
        ...
        /// </summary>
        public string[] PropertyNames => new[] { "DateTime", "Offset" };

        /// <summary>
        /// Gets the corresponding "property types".
        /// </summary>
        public IType[] PropertyTypes => new IType[] { NHibernateUtil.DateTime, NHibernateUtil.Int32 };
        ...
        private static DateTimeOffset? AsDateTimeOffset(object value)
        {
            ...
            if (ts == null)
            {
                throw new InvalidCastException(
                    $"Expected '{typeof(DateTimeOffset?)}' but received '{value.GetType()}'.");
            }
