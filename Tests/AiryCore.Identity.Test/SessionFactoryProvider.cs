namespace AiryCore.Identity.Test
{
    ...
    public class SessionFactoryProvider
    {
        ...
        /// </summary>
        public SessionFactoryProvider(bool useDateTimeOffsetWorkaround = false, string nHhibernateConfigFile = null)
        {
            this._configuration = new Configuration();
            if (nHhibernateConfigFile == null)
            {
            ...
            this.CreateNHibernateSessionFactory(useDateTimeOffsetWorkaround);
        }
        ...
        /// </summary>
        private void CreateNHibernateSessionFactory(bool useDateTimeOffsetWorkaround)
        {
            if (this.DefaultSessionFactory == null)
            {
                ...
                var domainMapper = new DefaultModelMapper(useDateTimeOffsetWorkaround);
                ...
                var mappingHelper = new MappingHelper<string, TestUser, int, TestUserClaim, TestLogin, TestUserToken, string, TestRole, int, TestRoleClaim>(domainMapper);
